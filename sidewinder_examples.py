...
t = sw.shorthand_to_midi(giant_steps, giant_steps_durs, name='midi_out\\giant_steps') # no need to specify a key
...
t = sw.chords_to_midi(sentimental, sentimental_durs, name='midi_out\\sentimentals', voicing='smooth') # no need to specify a key
tb = sw.chords_to_bassline_midi(sentimental, sentimental_durs, name='midi_out\\sentimental_bass')
...
t = sw.chords_to_midi(somedaymyprince, somedaymyprince_durs, name='midi_out\\prince_r', voicing='rootless') # no need to specify a key
...
t = sw.chords_to_midi(blueingreen, blueingreen_durs, name='midi_out\\blueingreen_sh', voicing='shell') # no need to specify a key
tb = sw.chords_to_bassline_midi(blueingreen, blueingreen_durs, name='midi_out\\blueingreen_bass')
